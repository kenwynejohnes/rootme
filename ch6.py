...
URL1 = 'http://challenge01.root-me.org/programmation/ch1/' #defining URL
URL2= 'http://challenge01.root-me.org/programmation/ch1/ep1_v.php?result=' #Defining URL

def main():
  ''' download file and return it as string '''
  cj = http.cookiejar.CookieJar() #CookieJar method stores HTTP cookies. It extracts cookies from HTTP requests and returns them in HTTP responses.
