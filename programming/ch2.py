...
import socket #connect special library socket
...
def ep2_solve():
    bot.send("PRIVMSG Candy :!ep2\n") #send message to Candy Bot
    smsg = ""
    smsg = bot.recv(7000)
    print(smsg)
    smsg1=smsg[41:smsg.find(":")-1]
    smsg2=str.decode(smsg1, 'base64')
    bot.send("PRIVMSG Candy :!ep2 -rep " + smsg2 + " \n")
    print("Answer sent")
    print(bot.recv(7000))
